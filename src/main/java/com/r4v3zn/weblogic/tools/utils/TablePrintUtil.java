...
import static com.r4v3zn.weblogic.tools.utils.VulUtils.getVulList;
...
public class TablePrintUtil {
     ...
     * 默认不等宽
     */
    private boolean equilong = false;
    ...
    public static void main(String[] args) {
        ...
        String rsp = TablePrintUtil.build(rows).setAlign(TablePrintUtil.ALIGN_LEFT).setEquilong(true).getTableString();
