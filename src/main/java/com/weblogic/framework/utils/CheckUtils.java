...
import static com.weblogic.framework.utils.SocketUtils.getNameService;
import static com.weblogic.framework.utils.VersionUtils.VERSION_T3;
...
public class CheckUtils {
    ...
    public static void checkIIOP(String target) throws Exception {
        ...
        try {
            byte[] rspByte = getNameService(socket);
